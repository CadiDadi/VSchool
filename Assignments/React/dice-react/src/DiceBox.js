...
class DiceBox extends Component {
    ...
    generateDiceNumbers = () => {
        //if - up to 3 rolls, dice roll continues (else below) 
        if(this.state.rollCount !== 3){
            ...
            // save numbers in state - if selected, dont change
    ...
    render(){
        return (
            <div>
                ...
                <button onClick={this.resetButton}>Reset Dice</button>
