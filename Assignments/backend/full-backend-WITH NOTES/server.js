...
// make multiple routes, separated for different things - planets, users, etc
// app.use('/user', require('./routes/user'))



// Database Connect                         
// name of db on local hard drive
mongoose.connect('mongodb://localhost:27017/planets', {useNewUrlParser: true}, () => {
