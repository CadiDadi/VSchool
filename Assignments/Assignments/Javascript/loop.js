...
// Add an isAdmin property to each of the users in this array.
    ...
    console.log(users) // All users now have an isAdmin & isTaco properties
...
var count = 0
var countComputer = 'computer'
for (var i = 0; i < officeItems.length; i++) {
    if(officeItems[i] === countComputer) count++;
}
console.log(count)

// extra practice 

var arr = [1,2,3,2,3,2,1,3,3,3,3,4,3]
var counting = 0
var myNumber = 3

for (var i = 0; i < arr.length; i++) {
  if (arr[i] == myNumber) counting++;
}
